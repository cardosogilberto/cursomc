...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
			...
			Cliente cli1 = new Cliente(null, "Maria Silva", "nelio1.cursos@gmail.com", "21258543508", TipoCliente.PESSOAFISICA, pe.encode("123"));
			
			cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
			
			Cliente cli2 = new Cliente(null, "Ana Costa", "nelio1.iftm@gmail.com", "67748746737", TipoCliente.PESSOAFISICA, pe.encode("123"));
